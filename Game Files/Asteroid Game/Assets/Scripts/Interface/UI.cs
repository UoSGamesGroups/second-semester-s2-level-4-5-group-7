...
public class UI : MonoBehaviour {
	...
	void Update ()
    {
        ...
        else if (healthControl.Health == 4) HP5.SetActive(false);
        //when health is 3, show only 3 sprites 
        else if (healthControl.Health == 3) HP4.SetActive(false);
        //when health is 2, show only 2 sprites
        else if (healthControl.Health == 2) HP3.SetActive(false);
        //when health is 1, show only 1 sprites
        else if (healthControl.Health == 1) HP2.SetActive(false);
        //when health is 0, show no sprites
        else if (healthControl.Health == 0) HP1.SetActive(false);
